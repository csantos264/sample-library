...
<body>
    <div class="payment-container" style="max-width:400px;margin:60px auto;background:#fff;padding:2.5rem 2.5rem 2rem 2.5rem;border-radius:16px;box-shadow:0 2px 16px rgba(44,62,80,0.13);text-align:center;position:relative;">
        <button onclick="window.location.href='admin_page.php'" type="button" style="position:absolute;left:16px;top:16px;background:none;border:none;color:#532c2e;font-size:1rem;display:flex;align-items:center;gap:0.5rem;
        cursor:pointer;padding:0.35rem 0.9rem 0.35rem 0.5rem;border-radius:7px;box-shadow:none;transition:background 0.2s;min-height:unset;min-width:unset;line-height:1.1;">
            ...
            <span style="font-size:0.98em;">Back to Admin Dashboard</span>
        </button> <br> <br>
        <h2 style="color:#532c2e;margin-bottom:1.2rem;">Pay Overdue Fine</h2>
        ...
        <?php else: ?>
            ...
            <a href="receipt.php?borrow_id=<?= $borrow_id ?>" class="btn" style="margin-top:0.5rem;">View Receipt</a>
            <a href="borrow-book.php" class="btn" style="margin-top:0.7rem;background:#C5832B;color:#fff;">View Another Receipt</a>
        <?php endif; ?>
    </div>
</body>
</html>